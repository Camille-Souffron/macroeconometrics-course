...
For the underlying probability language, information sets, white noise, and ergodicity, see the mathematical foundations chapter (@sec-stochastic-processes-foundations).
:::
...
The approximation linking a log difference to a proportional growth rate follows from Taylor’s expansion and is recalled in @sec-functions-transformations.
...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=stationarity).
...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=breaks).
...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=seasonality).
