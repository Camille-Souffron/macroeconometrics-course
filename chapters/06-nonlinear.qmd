...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=tar).
...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=star).
...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=markov).
...
The basic Markov property and the distinction between a hidden state and observed data are introduced in @sec-stochastic-processes-foundations and @sec-state-space-foundations.
...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=tvp).
...
The vectorisation notation and the filtering versus smoothing distinction are reviewed in @sec-decompositions and @sec-state-space-foundations.
...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=lp).
