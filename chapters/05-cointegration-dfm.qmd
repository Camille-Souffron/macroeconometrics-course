...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=panel).
...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=vecm).
...
The relation between rank, independent directions, and the dimension of a null space is reviewed in @sec-linear-algebra-foundations.
...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=dfm).
...
The spectral theorem, SVD, and rotation indeterminacy underlying this construction are reviewed in @sec-decompositions.
...
The distinction between a latent state, filtering, and smoothing is introduced in @sec-state-space-foundations.

## Factor-augmented VAR (FAVAR) {#sec-favar}

[Open this specification in the Interactive Lab](../interactive-lab.html?method=favar).
