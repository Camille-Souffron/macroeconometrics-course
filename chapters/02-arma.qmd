...
The operator notation used below is introduced from first principles in @sec-lag-operator-foundations; it is the algebraic counterpart of shifting a series one date into the past.
...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=arma-simulation).
...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=arma).
