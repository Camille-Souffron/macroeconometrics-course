...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=linear-projection).
...
### Decompositions: choose coordinates that reveal structure {#sec-decompositions}
...
### Functions, logarithms, and rates of change {#sec-functions-transformations}
...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=sampling).
...
### Joint distributions, information, and prediction {#sec-joint-distributions}
...
### From population restrictions to estimators {#sec-gmm}
...
### Time shifts, innovations, and the Wold representation {#sec-lag-operator-foundations}
...
### States, observations, and filtering {#sec-state-space-foundations}
...
![A state-space model separates the unobserved state’s transition from the observation equation. Filtering uses the observations available at a date, whereas smoothing can revise historical states after later data arrive.](../figures/mathematics/state-space-filtering-diagram.png){#fig-state-space}
...
[Open this specification in the Interactive Lab](../interactive-lab.html?method=samplers).
